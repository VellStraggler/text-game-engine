...
g.objs.new("table","T",geom="skeleton",color=wood)
...
g.acts.new("","location","g","sound",[235,15,235,45,"under/map1.txt","under/3steps_away.wav"])
g.acts.new("","location","g","change_map",[235,15,235,45,"under/map1.txt","under/upstairs.txt"])
g.acts.new("","location","g","sound",[235,47,235,18,"under/upstairs.txt","under/3steps_away.wav"])
